...
(SOMIX.Code (id: 9 )
  (name 'method_two')
  (technicalType 'PythonMethod')
  (uniqueName 'test.subfolder2.test2.ClassTwo.method_two')
  (linkToEditor 'vscode://file/{current_dir2}/test/subfolder2/test2.py/:6:5')
)
(SOMIX.Code (id: 10 )
  (name 'method_three')
  (technicalType 'PythonMethod')
  (uniqueName 'test.subfolder2.test2.ClassTwo.method_three')
  (linkToEditor 'vscode://file/{current_dir2}/test/subfolder2/test2.py/:13:5')
)
(SOMIX.Code (id: 11 )
  (name 'method_four')
  (technicalType 'PythonMethod')
  (uniqueName 'test.subfolder2.test2.ClassTwo.method_four')
